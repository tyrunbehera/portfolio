      ...
      <div className="max-w-[1220px] mx-auto px-6">
        <div className="section-card">
          ...
          <div className="relative">
            ...
            <div
              aria-hidden="true"
              className="absolute left-[9px] top-3 bottom-3 w-px bg-gradient-to-b from-[#4cc9f0] via-[rgba(76,201,240,0.25)] to-transparent"
            />
              ...
              {experience.map((job, idx) => (
                <article key={idx} className="relative">
                  ...
                  <div className="rounded-2xl border border-[rgba(143,170,200,0.14)] bg-[rgba(10,18,28,0.75)] p-6 hover:border-[rgba(76,201,240,0.25)] hover:bg-[rgba(10,22,36,0.85)] transition-all duration-300">
                    ...
                    <div className="flex flex-wrap items-start justify-between gap-3 mb-2">
                      <div>
                        <div className="flex flex-wrap items-center gap-2 mb-1">
                          <h3 className="text-xl font-bold text-[#e8f0fb]">{job.role}</h3>
                          {job.current && (
                    ...
                    {/* Summary */}
                    <p className="text-[#7ce8d4] text-sm italic mb-4 pl-0.5 border-l-2 border-[rgba(124,232,212,0.3)] pl-3">
                      {job.summary}
                    </p>
                    ...
                    <ul className="space-y-2.5">
                      {job.bullets.map((b, bi) => (
                        <li
                          key={bi}
                          className="flex items-start gap-3 text-[#a7bbd2] text-sm leading-relaxed"
                        >
                          <span
                            aria-hidden="true"
                            className="mt-[6px] w-1.5 h-1.5 rounded-full bg-[#4cc9f0] shrink-0 opacity-80"
                          />
                          {b}
                        </li>
                      ))}
