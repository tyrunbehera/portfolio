    ...
    >
      ...
      <div aria-hidden="true" className="pointer-events-none absolute inset-0 z-0">
        ...
        <div
          ...
          style={{
            background: "linear-gradient(135deg,rgba(255,109,77,0.85),rgba(251,91,59,0.8))",
        ...
        <div
          ...
          style={{
            background: "linear-gradient(135deg,rgba(33,200,240,0.7),rgba(34,158,197,0.75))",
      ...
      <div className="relative z-10 max-w-[1220px] mx-auto px-6 w-full">
        ...
        <div className="rounded-2xl border border-[rgba(143,170,200,0.18)] bg-[rgba(9,18,28,0.85)] shadow-[0_24px_60px_rgba(0,0,0,0.5)] overflow-hidden backdrop-blur-sm">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg,transparent 0%,rgba(76,201,240,0.6) 35%,rgba(124,232,212,0.6) 65%,transparent 100%)",
            }}
          />
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-7 px-8 pt-8 pb-7">
            ...
            {/* Photo — rendered at 2× to avoid blur */}
            <div className="relative shrink-0">
              <div
                className="w-[130px] h-[130px] rounded-full overflow-hidden border-2 border-[rgba(124,232,212,0.45)]"
                style={{ boxShadow: "0 0 0 6px rgba(76,201,240,0.1), 0 0 30px rgba(76,201,240,0.12)" }}
              >
                <Image
                  src="/assets/profile.png"
                  alt="Tarun N. Behera — DevOps Engineer"
                  width={260}
                  height={260}
              ...
              {/* Online badge */}
              <span className="absolute bottom-1.5 right-1.5 flex items-center justify-center w-5 h-5 rounded-full bg-[#010b14] border-2 border-[#010b14]">
            ...
            <div className="flex-1 min-w-0">
              <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-[#e2ecf8] leading-tight mb-1.5">
                {personal.name}
              </h1>
              ...
              <div className="flex flex-wrap gap-3 mt-5">
                <a
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#4cc9f0] text-[#010b14] font-bold text-sm hover:bg-[#38b8de] transition-colors shadow-[0_4px_20px_rgba(76,201,240,0.3)]"
                >
                  Email Me
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl border border-[rgba(76,201,240,0.3)] text-[#4cc9f0] font-semibold text-sm hover:bg-[rgba(76,201,240,0.1)] transition-colors"
                >
                  LinkedIn ↗
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl border border-[rgba(143,170,200,0.2)] text-[#a7bbd2] font-semibold text-sm hover:bg-[rgba(255,255,255,0.04)] transition-colors"
                >
                  GitHub ↗
                </a>
              </div>
            ...
            <div className="shrink-0 w-full sm:w-auto border border-[rgba(143,170,200,0.16)] rounded-xl bg-[rgba(6,14,24,0.95)] p-5 min-w-[210px]">
              ...
              {[
                ...
                <div
                  key={label}
                  className="flex items-center justify-between gap-4 py-2 border-t border-[rgba(255,255,255,0.05)]"
                >
                  <span className="text-[#a7bbd2] text-xs">{label}</span>
                  <span className={`font-semibold text-xs text-right ${green ? "text-[#7ae8af]" : "text-[#e8f0fb]"}`}>
                    {value}
                  </span>
                </div>
              ))}
            ...
            {personal.stats.map(({ label, value }, i) => (
              <div
                ...
                className={`px-8 py-5 text-center ${
                  i < personal.stats.length - 1 ? "border-r border-[rgba(143,170,200,0.1)]" : ""
                }`}
              >
        ...
        <div className="mt-6 section-card">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-[#e8f0fb] mb-4 leading-snug max-w-3xl">
            Building secure, automated, and cost-efficient platforms at scale.
          </h2>
          <div className="space-y-3">
            {personal.about.map((para, i) => (
              <p key={i} className="text-[#a7bbd2] leading-[1.85] text-[0.97rem]">
                {para}
              </p>
            ))}
          </div>
