          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-7 px-8 pt-8 pb-7">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex flex-wrap gap-3 mt-5">
                <a href={`mailto:${personal.email}`} className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl border border-[rgba(76,201,240,0.3)] text-[#4cc9f0] font-semibold text-sm hover:bg-[rgba(76,201,240,0.1)] transition-colors anim-pop anim-d1">Email Me</a>
                <a href={personal.linkedin} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl border border-[rgba(76,201,240,0.3)] text-[#4cc9f0] font-semibold text-sm hover:bg-[rgba(76,201,240,0.1)] transition-colors anim-pop anim-d2">LinkedIn ↗</a>
                <a href={personal.github} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl border border-[rgba(76,201,240,0.3)] text-[#4cc9f0] font-semibold text-sm hover:bg-[rgba(76,201,240,0.1)] transition-colors anim-pop anim-d3">GitHub ↗</a>
              </div>
            </div>
